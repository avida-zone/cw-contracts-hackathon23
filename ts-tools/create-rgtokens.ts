...
(async function create_rg_tokens() {
  ...
  let rg20_instant_msg: RgInstMsg = {
    ...
    marketing: {
      description:
        "Credentials Required: Issuance by the Hogwarts School of Witchcraft and Wizardry",
      logo: {
        url: "https://logos-world.net/wp-content/uploads/2020/12/Hogwarts-Logo.png",
      },
    },
    mint: { cap: "1000000000000", minter: launchpad },
    name: "Hogwarts Medallions",
  ...
  let rg20_instant_msg_transform: RgInstMsg = {
    ...
    initial_balances: [],
    marketing: {
      description: "AVIDA community rgToken",
      logo: {
        url: "https://cdn.discordapp.com/attachments/1094991943655768145/1103370695347548180/logo-white.png",
      },
    },
