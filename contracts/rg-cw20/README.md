# Example of Trusted Crypto Asset

This is source from the cw-plus repo - cw20_base contract with the addition of checks with the `vc-verifier` as an example for the
[Trusted Crypto Assets](https://github.com/nymlab/trusted-crypto-asset) framework.
